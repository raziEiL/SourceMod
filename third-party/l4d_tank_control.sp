...
bool g_bIsFinale;
ConVar g_hCvarDisable;

public Plugin:myinfo =
{
    name = "L4D2 Tank Control",
    author = "arti, raziEiL [disawar1]",
...
public OnPluginStart()
{
	...
	g_hCvarDisable = CreateConVar("tankcontrol_disable_on_final", "1", "Disable on finale", FCVAR_PLUGIN);
}
